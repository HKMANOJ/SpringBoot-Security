		...
		<form  th:action="@{/login}" method="post" modelAttribute="user">
			<div class="row">
				...
				<div class="col">
					...
					<input type="text" name="name" placeholder="name" required  path=name id="name" required>
					<input type="password" name="password" placeholder="password" path="password" id="password"
